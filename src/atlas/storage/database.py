...
def _allows_local_database_fallback(environment: str) -> bool:
    """Return whether local SQLite fallback is allowed for this environment."""
...
class Database:
    ...
    def _get_connection_string(self) -> str:
        ...
        if not _allows_local_database_fallback(settings.environment):
